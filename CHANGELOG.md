...
### Добавлено
- Возможность кастомизации названия слёта
- Возможность добавления участников без отряда

### Изменено
- Список разделов системы на главной странице
- Сокрытие неиспользуемых разделов системы
