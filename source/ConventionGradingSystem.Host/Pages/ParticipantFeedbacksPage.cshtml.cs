...
using ConventionGradingSystem.Host.Models.ParticipantFeedbacksPage;
...
/// <summary>
/// Модель страницы приложения со списком отзывов участников о мероприятии в рамках конкурса мероприятий.
/// </summary>
[Authorize(Roles = "Administrator")]
public class ParticipantFeedbacksPageModel : PageModel
{
    private readonly ApplicationConfiguration _configuration;
    private readonly DatabaseContext _databaseContext;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="ParticipantFeedbacksPageModel"/>.
    /// </summary>
    ...
    public ParticipantFeedbacksPageModel(
