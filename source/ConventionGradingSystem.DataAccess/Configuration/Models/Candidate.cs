...
public class Candidate
{
    ...
    /// Каждое значение должно быть уникальным в рамках кандидита. Список может быть пустым, если
    /// зрителям допустимо отдавать голоса за кандидатов, имеющих прямое отношение к тому же отряду,
    /// что и сами зрители.</remarks>
